...
namespace DoAnQuanLyKhachSanLTQL.Migrations
{
    ...
    [Migration("20250510022541_UpdateConstraistPayment")]
    partial class UpdateConstraistPayment
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DoAnQuanLyKhachSanLTQL.Data.Customer", b =>
                {
                    ...
                    b.ToTable("Customers", t =>
                        {
                            t.HasCheckConstraint("CK_Customer_Gender", "Gender IN ('Nam', 'Nữ', 'Giới tính thứ 3')");
                        });
                });
            ...
            modelBuilder.Entity("DoAnQuanLyKhachSanLTQL.Data.Invoice", b =>
                {
                    ...
                    b.ToTable("Invoices", t =>
                        {
                            t.HasCheckConstraint("CK_Invoice_PaymentType", "PaymentType IN ('Tiền mặc', 'Thẻ tín dụng')");
                        });
                });
            ...
            modelBuilder.Entity("DoAnQuanLyKhachSanLTQL.Data.Staff", b =>
                {
                    ...
                    b.ToTable("Staffs", t =>
                        {
                            t.HasCheckConstraint("CK_Staff_Gender", "Gender IN ('Nam', 'Nữ', 'Giới tính thứ 3')");
                        });
                });
