        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Customer_Gender", "Gender IN ('Nam', 'Nữ', 'Giới tính thứ 3')");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RoomTypeDesc = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    RoomTypeImg = table.Column<byte[]>(type: "varbinary(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Staff_Gender", "Gender IN ('Nam', 'Nữ', 'Giới tính thứ 3')");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Invoice_PaymentType", "PaymentType IN ('Tiền mặc', 'Chuyển khoảng')");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServiceUses", x => new { x.InvoiceId, x.ServiceId });
                    table.ForeignKey(
                        name: "FK_ServiceUses_Invoices_InvoiceId",
                        column: x => x.InvoiceId,
                        principalTable: "Invoices",
                        principalColumn: "InvoiceId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ServiceUses_Services_ServiceId",
